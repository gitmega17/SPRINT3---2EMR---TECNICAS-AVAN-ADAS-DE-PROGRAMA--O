...
const SensorDataChart = () => {
  ...
  useEffect(() => {
    ...
    if (token) {
      const interval = setInterval(updateChartData, 5000); // Intervalo de 10 segundos
...
return (
    <div>
      <canvas id="temp-chart" width="1000" height="400"></canvas>
      <canvas id="humidity-chart" width="1000" height="400"></canvas>
    </div>
  );
};
